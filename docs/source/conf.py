...
# object_detection_dofus_bot documentation build
...
from object_detection_dofus_bot import __version__ as release

# -- Project information -----------------------------------------------------

project = "object_detection_dofus_bot"
author = "Kedro"
...
htmlhelp_basename = "object_detection_dofus_botdoc"
...
latex_documents = [
    (
        master_doc,
        "object_detection_dofus_bot.tex",
        "object_detection_dofus_bot Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "object_detection_dofus_bot",
        "Project object_detection_dofus_bot codebase.",
        "Data-Science",
    )
]
